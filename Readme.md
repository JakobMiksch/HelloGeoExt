...
This a prototype of a GeoExt application. Initially created with [this instruction](https://github.com/geoext/geoext3/blob/master/universal-app.md).
...
Only tested on `Windows 10` with `Sencha Cmd v6.5` and `Ext JS 6.2 (GPL)` so far. But should run on Linux or Mac as well. 
